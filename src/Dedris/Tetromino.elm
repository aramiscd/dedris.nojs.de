...
i =
    { type_ = I
    , blocks = fromTuples [ (2,0) , (2,1) , (2,2) , (2,3) ]
    }
...
j =
    { type_ = J
    , blocks = fromTuples [ (1,0) , (1,1) , (1,2) , (2,2) ]
    }
...
l =
    { type_ = L
    , blocks = fromTuples [ (1,0) , (1,1) , (1,2) , (2,0) ]
    }
...
o =
    { type_ = O
    , blocks = fromTuples [ (0,0) , (0,1) , (1,0) , (1,1) ]
    }
...
s =
    { type_ = S
    , blocks = fromTuples [ (0,1) , (0,2) , (1,0) , (1,1) ]
    }
...
t =
    { type_ = T
    , blocks = fromTuples [ (1,0) , (1,1) , (1,2) , (2,1) ]
    }
...
z =
    { type_ = Z
    , blocks = fromTuples [ (1,0) , (1,1) , (2,1) , (2,2) ]
    }
